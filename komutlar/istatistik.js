...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    .setColor("YELLOW")
    .addField("**__Ping__**",`<a:bluesiren:806815067781857290> Mesaj Gecikmesi: ${new Date().getTime() - message.createdTimestamp} ms\n <a:B_Kirmizi:806833231411675176> Bot Gecikmesi: ${client.ws.ping}ms`, true)
    ...
    .addField("**__Bot Sahibi__**", `Fearless#5332 || GizemliOyuncuYT
#5008`, true)
    .addField("**__Geliştirici__**", `Fearless#5332 || GizemliOyuncuYT
#5008`, true)
